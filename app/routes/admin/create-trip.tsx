...
const CreateTrip = ({loaderData}: Route.ComponentProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        setLoading(true);
        const {country, budget, groupType, interest, travelStyle, duration} = formData;
    ...
    // Create a template function for the dropdown items
        ...
        return (
            <div className="flex items-center gap-2">
                <img
                    src={data.flag}
                    alt={data.text}
                    className="h-4 w-6 object-cover text-gray-700 ms-4"
