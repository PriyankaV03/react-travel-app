...
import {getAllTrips, getTripById} from "~/routes/api/trips";
...
const TripDetail = ({loaderData}: Route.ComponentProps) => {
    ...
    const {
        ...
        budget, interests, estimatedPrice, description, bestTimeToVisit, weatherInfo,
        country
    } = tripData || {};
        ...
        <main className="travel-detail wrapper">
            ...
            <section className="container wrapper-md">
                ...
                {visitTimeAndWeatherInfo.map((info) => (
                    <section key={info.title} className="visit">
                        <div>
                            <h3>{info.title}</h3>
                            <ul>
                                {info.items?.map((item) => (
