...
import {getAllTrips} from "~/routes/api/trips";
...
const FeaturedDestination = ({
    ...
    <section
        className={cn('rounded-[14px] overflow-hidden bg-cover bg-center size-full min-w-[280px]', containerClass, bgImage)}>
            ...
            <article className="featured-card">
                ...
                <article className="flex flex-col gap-3.5">
                    ...
                    <figure className="flex gap-2 items-center">
                        <img
                            src="/assets/images/priyankaAI.png"
                            alt="user"
                    ...
                    <section className="wrapper">
                        <article>
                            <h1 className="p-72-bold text-dark-100">
                                Use AI for your Travel Plan
                            </h1>

                            <p className="text-dark-100">
                                Customize your travel plans, choose your destination as per your interest.
                            </p>
                        </article>
